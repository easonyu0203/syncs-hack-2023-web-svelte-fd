...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_images();
  $$unsubscribe_page();
  return `<main class="container h-screen bg-surface-900 relative flex flex-col justify-start items-center px-8"><div class="mt-4 flex justify-between w-full">${validate_component(SunnyTitle, "SunnyTitle").$$render($$result, { actionName: "Events" }, {}, {})} ${validate_component(HomeButton, "HomeButton").$$render($$result, {}, {}, {})}</div> <label class="label"><input class="input p-2 px-6 w-56 rounded-lg" type="text" placeholder="Search Events"${add_attribute("value", searchTerm, 0)}></label> <section class="flex flex-col mt-6 gap-4">${each(events, (imgDoc) => {
